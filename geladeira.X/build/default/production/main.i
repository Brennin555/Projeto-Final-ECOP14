    ...
    for (;;)
    {
        ...
        if (kpRead() != tecla)
        {
            ...
            if (((tecla) & (1<<(2))))
            {
                ...
                if ((potenciaUpdate == 1)&&(nMensagem>5))
                {
                    lcdCommand(0x01);
                    nMensagem = 0;
                    potenciaUpdate = 0;
                ...
                if ((nMensagem == 1) || (nMensagem == 2) || (nMensagem > 5))
                {
                    if (nMensagem == 1)
                    {
        ...
        ssdDigit(potenciaG - 5, 0);
        ssdDigit(potenciaF - 5, 1);
        ...
        ssdUpdate();
        for (vtempo = 0; vtempo < 125; vtempo++);
    }
    return;
}
